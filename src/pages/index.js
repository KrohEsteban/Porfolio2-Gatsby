...
import {perfil, fotoperfil, textoperfil, presentacion, handwriting, texto, animacionopacidad, frase, brillosize} from '../styles/index.module.css'
import { Link, graphql } from "gatsby"
import { Col, Container, Row } from "react-bootstrap"
import { useInView } from 'react-intersection-observer';
import Butonbrillo from "../components/buttonbrillo"
  ...
  return(
    ...
    <>
      ...
      <div className={presentacion}>
        ...
        <p className={frase}>"{data.dataJson.presentacion[0].frase}"</p>
      ...
      <div className="mt-5">
        <Container >
        <Row>
          <Col xs ="12" md="2" lg="3" className="d-flex align-items-center justify-content-center">
            <div></div>
          </Col>
          <Col xs ="12" md="4" lg="3" className="mt-5 d-flex align-items-center justify-content-center">
            <Link ref={ref} className={brillosize} to='/tu-web' ><Butonbrillo inView={inView} texto={data.dataJson.presentacion[0].button1}/></Link>
          </Col>

          <Col xs ="12" md="4" lg="3" className="mt-5 d-flex align-items-center justify-content-center ">
           
            <Link ref={ref} className={brillosize} to='/aptitudes' ><Butonbrillo inView={inView} texto={data.dataJson.presentacion[0].button2}/></Link>
